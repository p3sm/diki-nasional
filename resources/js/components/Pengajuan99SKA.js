    ...
    render() {
        return (
          <div>
            ...
            <Alert stack={{limit: 3}} position='top-right' offset={50} effect='slide' timeout={5000}/>
          </div>
        );
    }
}

if (document.getElementById('pengajuan99_ska')) {
    ReactDOM.render(<Personal />, document.getElementById('pengajuan99_ska'));
}
